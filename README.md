 ...
 **_Please note that this GitHub project is no longer being maintained and has been migrated to a new repository. We recommend that you use the [IP2Location.io R SDK](https://github.com/ip2location/ip2location-io-r) going forward._**
